...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/login", {
                email,
                password
            });
...
//# sourceMappingURL=src_app_1xfrpfj._.js.map